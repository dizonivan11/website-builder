...
<div class="inner-wrapper">
    <img src="https://pbs.twimg.com/profile_images/1116825930/windows98od1_400x400.jpg">
					...
					<div class="col-wrapper col col-lg-3 col-md-3 col-sm-12" id="2648"><div class="col-resizer" data-flag="builder-element"><span>‖</span></div>
						<div id="2663" class="widget-wrapper" widget-name="widgets/Headings">
<div class="inner-wrapper">
    <h3 class="main-headings">Windows 98</h3>
</div></div><button class="drop-zone-min" onclick="DropElement(this, event);" data-flag="builder-element">+</button>
					</div><div id="2664" class="col-wrapper col col-lg-3 col-md-3 col-sm-12"><div class="col-resizer" data-flag="builder-element"><span>‖</span></div>    <button class="drop-zone" onclick="DropElement(this, event);" data-flag="builder-element">Add Selected Element</button>
</div><div id="4801" class="col-wrapper col col-lg-3 col-md-3 col-sm-12"><div class="col-resizer" data-flag="builder-element"><span>‖</span></div>    <button class="drop-zone" onclick="DropElement(this, event);" data-flag="builder-element">Add Selected Element</button>
</div>
				</div>
			</div>
		</div>
	...
	<div class="row-wrapper" id="2511">
		<div class="container">
			<div class="row">
				<div class="col-wrapper col col-lg-12 col-md-12 col-sm-12" id="2649">
...
<div class="inner-wrapper">
    <p class="text-content">Hello,&nbsp;<a href="#" target="_blank">this link opens in new tab</a>, try also the <b><u>other link</u></b> below which does nothing.<br></p>
...
<div class="inner-wrapper">
	...
	<footer>
		<div class="row-wrapper" id="2512">
			<div class="container">
				<div class="row">
					<div class="col-wrapper col col-lg-4 col-md-4 col-sm-12" id="2650">
						<div id="2530" class="widget-wrapper" widget-name="widgets/Headings">
<div class="inner-wrapper">
    <h3 class="main-headings">Quick Links</h3>
    ...
    <nav>
        <ul>
            ...
            <li><a href="#">Contact Us</a></li>
					...
					<div class="col-wrapper col col-lg-4 col-md-4 col-sm-12" id="2651"><div class="col-resizer" data-flag="builder-element"><span>‖</span></div>
...
<div class="inner-wrapper">
    <div class="text-content"><b>Phone:</b> 0999-999-9999<div><b>Fax:</b>&nbsp;0123-456-7890</div><div><b>Email:</b> noreply@email.com<br><div><b>Address:</b> #123 Street, City, Province, Country</div></div></div>
					...
					<div class="col-wrapper col col-lg-4 col-md-4 col-sm-12" id="2652"><div class="col-resizer" data-flag="builder-element"><span>‖</span></div>
